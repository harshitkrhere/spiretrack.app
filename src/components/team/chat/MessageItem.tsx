        ...
        <div className="flex-1 min-w-0">
          {!isGrouped && (
            <div className="flex items-baseline gap-2 mb-1">
              <span className="font-medium text-sm text-gray-900">
                ...
                {!message.user_id && !message.is_system_message && (
                  <span className="ml-1.5 text-[10px] font-medium tracking-wide uppercase text-gray-400 bg-gray-100 px-1.5 py-0.5 rounded align-middle">AI</span>
                )}
              </span>
          ...
          {isEditing ? (
            ...
            <div className={cn(
              ...
              !message.user_id && !message.is_system_message && "pl-3 border-l-2 border-gray-200"
            )}>
