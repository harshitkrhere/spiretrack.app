...
interface CollaborationTrendChartProps {
  data: TrendData[];
  loading?: boolean;
}

export const CollaborationTrendChart: React.FC<CollaborationTrendChartProps> = ({ data, loading }) => {
  if (loading) {
    return (
